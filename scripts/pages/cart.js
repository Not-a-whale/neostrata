  define(['modules/api',
    ...
    var CartView = Backbone.MozuView.extend({
        ...
        handleAutoshipOption: function(e){
          ...
          item.apiUpdate().then(function(data){
            console.log('Item Update is done '); 
            var couponName = item.get('product.productCode') +"_couponcode_autogenerated";  
            if (item.get('data') !== '') {
              self.model.set('couponCode',couponName);
              self.addCoupon(); 
            } else {
              self.model.removeCoupon(couponName);
            } 
        ...
        removeItem: function(e) {
            ...
            var $removeButton = $(e.currentTarget),
                ...
                item = this.model.get("items").get(id),
                couponName = item.get('product.productCode') +"_couponcode_autogenerated";
            //this.model.removeCoupon(couponName);
            this.model.removeItem(id, couponName);
            return false; 
        },
        empty: function() {
